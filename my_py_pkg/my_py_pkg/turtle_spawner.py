...
class TurtleSpawner(Node):
    ...
    def callback_call_spawn(self, future, turtle_name, x, y, theta):
        try:
            ...
            self.get_logger().error("Err : lors de l'appel au Server %r" % (e,))
...
if __name__ == "__main__":
    main()
#https://gitlab.etude.eisti.fr/didieragat/catch-me-if-you-can/-/tree/master/turtlesim_catch_me_if_you_can
# https://github.com/saratrajput/my_cpp_pkg/tree/8e127d1c7a574762a2b8ee84d679b0324660d05d
